...
interface RewriteStepModalProps {
  visible: boolean;
  stepTitle: string;
...
export const RewriteStepModal: React.FC<RewriteStepModalProps> = ({
  visible,
  stepTitle,
  onConfirm,
  onCancel,
      ...
      <Pressable style={styles.backdrop} onPress={handleCancel}>
        <Pressable style={styles.container} onPress={(e) => e.stopPropagation()}>
          <View style={styles.content}>
            <Text style={styles.title}>Rewrite Step</Text>
            <Text style={styles.message}>
              Tell us how you'd like to rewrite: "{stepTitle}"
            </Text>
            <TextInput
